...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/kingstore/ijinpremium/main/zeroip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/kingstore/ijinpremium/main/zeroip | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/kingstore/ijinpremium/main/zeroip | grep $MYIP | awk '{print $5}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/kingstore/ijinpremium/main/zeroip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/kingstore/ijinpremium/main/zeroip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/kingstore/update/main/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/kingstore/ijinpremium/main/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/kingstore/ijinpremium/main/versi)
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1 #$NC                                                     $COLOR1#$NC"
echo -e "$COLOR1 #$NC [ SLOWDNS : ${status_ws} ]  [ UDP : ${status_xray} ]   [ NGINX : ${status_nginx} ]  $COLOR1#$NC"
echo -e "$COLOR1 #$NC                                                     $COLOR1#$NC"
echo -e "$COLOR1 ####################################################### ${NC}"
echo -e "$COLOR1                                                                      ${NC}"
echo -e "$COLOR1################################################## ${NC}"
...
echo -e "$RED                                                                          ${NC}"
echo -e "$COLOR1 #############################################$NC"
echo -e "$COLOR1 # $NC Version     : ${GREEN}$(cat /opt/.ver) Latest Version${NC}   $COLOR1#$NC"
