...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/kingstores/ijinpremium/main/zeroip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/kingstores/ijinpremium/main/zeroip | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/kingstores/ijinpremium/main/zeroip | grep $MYIP | awk '{print $5}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/kingstores/ijinpremium/main/zeroip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/kingstores/ijinpremium/main/zeroip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/kingstores/ijinpremium/main/versi)
echo "$version_up" > /opt/.ver
echo -e "$COLOR1│${NC}  $COLOR1[INFO]${NC} Successfully Up To Date!"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • kingstores •                $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo ""
read -n 1 -s -r -p "  Press any key to back on menu"
menu
...
serverV=$( curl -sS https://raw.githubusercontent.com/kingstores/ijinpremium/main/versi)
if [ "$Isadmin" = "ON" ]; then
